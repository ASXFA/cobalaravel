                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{ url('/backside') }}">
                            ...
                            <a class="nav-link" href="{{ url('/backside/shirt') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tshirt"></i></div>
                                Shirt
                            </a>
                            <a class="nav-link" href="{{ url('/backside/socks') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-socks"></i></div>
                                Socks
                            </a>
                            <a class="nav-link" href="{{ url('/backside/phone') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-mobile-alt"></i></div>
                                Phone Case
                            </a>
                            <a class="nav-link" href="{{ url('/backside/transaction') }}">
